...
public class TEAZ31ServTechn_AddLocation2ServTech extends ProjSpecificMethods {
	@BeforeTest
	public void setecelfile() {
		testCaseName = "Add Location in Service Technician Record";
		testCaseDescription = "Adding location in Service Technician Record and verifying whether it is added successfully";
		author = "Suganya";
		excelfile="TEAZ010_AddLocation2Parent";
	}
	@Test(dataProvider = "getdata")
	public void AddLocationServTechn(String url,String uName, String Pwd, String searchname,String tradename, String phone,String addrtype,String addressline1, String city, String state, String zipcode) throws InterruptedException {
